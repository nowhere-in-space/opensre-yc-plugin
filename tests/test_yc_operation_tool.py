...
from yc_plugin.yandex_cloud.tools import execute_yc_operation
...
class TestRegistration:
    ...
    def test_credentials_are_hidden_from_the_model(self) -> None:
        tool = get_registered_tool_map("investigation")["execute_yc_operation"]
...
class TestEndpointRegistry:
    def test_log_reading_is_listed_separately_from_management(self) -> None:
        ...
        from yc_plugin.yandex_cloud.endpoints import known_endpoints
